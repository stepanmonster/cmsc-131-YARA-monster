...
#line 115 "libyara/hex_grammar.c"
...
#ifndef YY_HEX_YY_LIBYARA_HEX_GRAMMAR_H_INCLUDED
# define YY_HEX_YY_LIBYARA_HEX_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 78 "libyara/hex_grammar.y"

  int64_t integer;
  RE_NODE *re_node;

#line 187 "libyara/hex_grammar.c"
...
#endif /* !YY_HEX_YY_LIBYARA_HEX_GRAMMAR_H_INCLUDED  */
/* Symbol kind.  */
...
#line 96 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 945 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_token_sequence: /* token_sequence  */
#line 97 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 951 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_token_or_range: /* token_or_range  */
#line 98 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 957 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_token: /* token  */
#line 99 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 963 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_range: /* range  */
#line 102 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 969 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_alternatives: /* alternatives  */
#line 101 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 975 "libyara/hex_grammar.c"
        break;

    case YYSYMBOL_byte: /* byte  */
#line 100 "libyara/hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 981 "libyara/hex_grammar.c"
        break;
...
#line 108 "libyara/hex_grammar.y"
      {
        RE_AST* re_ast = yyget_extra(yyscanner);
        re_ast->root_node = (yyvsp[-1].re_node);
      }
#line 1260 "libyara/hex_grammar.c"
    break;

  case 3: /* tokens: token  */
#line 117 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[0].re_node);
      }
#line 1268 "libyara/hex_grammar.c"
    break;

  case 4: /* tokens: token token  */
#line 121 "libyara/hex_grammar.y"
      {
...
#line 1284 "libyara/hex_grammar.c"
    break;

  case 5: /* tokens: token token_sequence token  */
#line 133 "libyara/hex_grammar.y"
      {
...
#line 1295 "libyara/hex_grammar.c"
    break;

  case 6: /* token_sequence: token_or_range  */
#line 144 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = yr_re_node_create(RE_NODE_CONCAT);
...
#line 1308 "libyara/hex_grammar.c"
    break;

  case 7: /* token_sequence: token_sequence token_or_range  */
#line 153 "libyara/hex_grammar.y"
      {
        yr_re_node_append_child((yyvsp[-1].re_node), (yyvsp[0].re_node));
        (yyval.re_node) = (yyvsp[-1].re_node);
      }
#line 1317 "libyara/hex_grammar.c"
    break;

  case 8: /* token_or_range: token  */
#line 162 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[0].re_node);
      }
#line 1325 "libyara/hex_grammar.c"
    break;

  case 9: /* token_or_range: range  */
#line 166 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[0].re_node);
        (yyval.re_node)->greedy = false;
      }
#line 1334 "libyara/hex_grammar.c"
    break;

  case 10: /* token: byte  */
#line 175 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[0].re_node);
      }
#line 1342 "libyara/hex_grammar.c"
    break;

  case 11: /* $@1: %empty  */
#line 179 "libyara/hex_grammar.y"
      {
        lex_env->inside_or++;
      }
#line 1350 "libyara/hex_grammar.c"
    break;

  case 12: /* token: '(' $@1 alternatives ')'  */
#line 183 "libyara/hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[-1].re_node);
        lex_env->inside_or--;
      }
#line 1359 "libyara/hex_grammar.c"
    break;

  case 13: /* range: '[' _NUMBER_ ']'  */
#line 192 "libyara/hex_grammar.y"
      {
...
#line 1399 "libyara/hex_grammar.c"
    break;

  case 14: /* range: '[' _NUMBER_ '-' _NUMBER_ ']'  */
#line 228 "libyara/hex_grammar.y"
      {
...
#line 1435 "libyara/hex_grammar.c"
    break;

  case 15: /* range: '[' _NUMBER_ '-' ']'  */
#line 260 "libyara/hex_grammar.y"
      {
        if (lex_env->inside_or)
        {
...
#line 1461 "libyara/hex_grammar.c"
    break;

  case 16: /* range: '[' '-' ']'  */
#line 282 "libyara/hex_grammar.y"
      {
        if (lex_env->inside_or)
        {
          yyerror(yyscanner, lex_env,
...
#line 1481 "libyara/hex_grammar.c"
    break;

  case 17: /* alternatives: tokens  */
#line 302 "libyara/hex_grammar.y"
      {
          (yyval.re_node) = (yyvsp[0].re_node);
      }
#line 1489 "libyara/hex_grammar.c"
    break;

  case 18: /* alternatives: alternatives '|' tokens  */
#line 306 "libyara/hex_grammar.y"
      {
...
#line 1507 "libyara/hex_grammar.c"
    break;

  case 19: /* byte: _BYTE_  */
#line 323 "libyara/hex_grammar.y"
      {
...
#line 1520 "libyara/hex_grammar.c"
    break;

  case 20: /* byte: _NOT_BYTE_  */
#line 332 "libyara/hex_grammar.y"
      {
...
#line 1533 "libyara/hex_grammar.c"
    break;

  case 21: /* byte: _MASKED_BYTE_  */
#line 341 "libyara/hex_grammar.y"
      {
...
#line 1560 "libyara/hex_grammar.c"
    break;

  case 22: /* byte: _MASKED_NOT_BYTE_  */
#line 364 "libyara/hex_grammar.y"
      {
        uint8_t mask = (uint8_t) ((yyvsp[0].integer) >> 8);
...
#line 1575 "libyara/hex_grammar.c"
    break;


#line 1579 "libyara/hex_grammar.c"
...
#line 376 "libyara/hex_grammar.y"
